...
public interface Server_DB_Interface {
    ...
    /**
     * Get {@code Message}s to be sent from DB as a
     * {@code ConcurrentHashMap<Integer, Queue<Message>>}
     * 
     * @return {@code ConcurrentHashMap<Integer, Queue<Message>>}: recipients ID,
     *         message queues
     */
